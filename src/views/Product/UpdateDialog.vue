<template>
  <el-dialog v-model="props.dialogFormVisible" @close="closeDialog()" title="修改产品信息" width="1000">
    <el-form class="flex flex-col" ref="formRef" :model="props.form" :rules="rules" label-position="left"
          ...
          <div class="content px-8">
            ...
            <div class="item-group grid grid-cols-1 gap-4 px-8">
              <el-form-item prop="product_info.main_image" class="col-span-1" label-width="120px" required>
                ...
                <div  v-if="props.form.product_info.main_image" class="flex flex-col items-center mx-1">
                  <el-image style="width: 5rem; height: 5rem" :src="props.form.product_info.main_image" />
                  <el-button size="small" type="danger" :icon="Delete" class="mt-[3px]" @click="deleteMainImage" />
                </div>
                <FileUploader v-else :action="uploadUrl" :multiple="true" :limit="1" :before-upload="validateImage"
              ...
              <el-form-item prop="product_info.additional_images" class="col-span-1" label-width="120px" required>
                ...
                <div  v-if="props.form.product_info.additional_images" v-for="(item, index) in props.form.product_info.additional_images" class="flex flex-col items-center mx-1">
                  <el-image style="width: 5rem; height: 5rem" :src="item" />
                  <el-button size="small" type="danger" :icon="Delete" class="mt-[3px]" @click="deleteCarouselImage(index)" />
                </div>
              ...
              <el-form-item prop="product_info.details_images" class="col-span-1" label-width="120px" required>
                ...
                <div  v-if="props.form.product_info.details_images" v-for="(item, index) in props.form.product_info.details_images" class="flex flex-col items-center mx-1">
                  <el-image style="width: 5rem; height: 5rem" :src="item" />
                  <el-button size="small" type="danger" :icon="Delete" class="mt-[3px]" @click="deleteDetailsImage(index)" />
                </div>
                <FileUploader :action="uploadUrl" :multiple="true" :limit="5" :before-upload="validateImage"
            ...
            <div class="item-group grid grid-cols-5 gap-4 px-8">
              ...
              <el-form-item class="col-span-2"  label="库存数量" prop="product_sales.stock_quantity" required >
...
import {  ref,inject, defineProps, defineEmits, nextTick,onMounted } from 'vue'
